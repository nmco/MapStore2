...
var Api = {
    ...
    assignFiltersValue2: function(rulesFiltersValues, options) {
        if (rulesFiltersValues) {
            this.assignFilterValue(options.params, 'userName', 'userAny', rulesFiltersValues.userName);
            this.assignFilterValue(options.params, 'roleName', 'roleAny', rulesFiltersValues.roleName);
